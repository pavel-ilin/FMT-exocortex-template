...
> После установки агент подстраивается под твой язык: пишешь по-русски — отвечает по-русски, по-английски — по-английски. Язык автономных сообщений (дайджесты, напоминания) задаётся в настройках (`params.yaml → language`, по умолчанию русский).
