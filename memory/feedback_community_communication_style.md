...
2. **Иноязычное — только после описания на языке текста** (в EN-тексте русский термин после английского). Исключения: имена собственные (NixOS, PostgreSQL, Aisystant) и термины, которые сам участник употребляет. Жаргон запрещён: не «задеплоим», а «развернём»; не «зафейлилось», а «упало».
